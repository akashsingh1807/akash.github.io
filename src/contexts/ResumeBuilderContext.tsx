...
const initialState: ResumeBuilderState = {
  currentStep: 0,
  steps: [
    { id: 'template', title: 'Choose Template', description: 'Select a professional template', icon: 'Palette', completed: false, required: true },
    { id: 'personal', title: 'Personal Info', description: 'Add your contact details', icon: 'User', completed: false, required: true },
    { id: 'summary', title: 'Professional Summary', description: 'Write a compelling summary', icon: 'FileText', completed: false, required: true },
    { id: 'experience', title: 'Work Experience', description: 'Add your work history', icon: 'Briefcase', completed: false, required: true },
    { id: 'education', title: 'Education', description: 'Add your educational background', icon: 'GraduationCap', completed: false, required: true },
    { id: 'skills', title: 'Skills', description: 'List your technical and soft skills', icon: 'Code', completed: false, required: true },
    { id: 'projects', title: 'Projects', description: 'Showcase your key projects', icon: 'Folder', completed: false, required: false },
    { id: 'certifications', title: 'Certifications', description: 'Add professional certifications', icon: 'Award', completed: false, required: false },
    { id: 'languages', title: 'Languages', description: 'List languages you speak', icon: 'Globe', completed: false, required: false },
    { id: 'review', title: 'Review & Download', description: 'Final review and download', icon: 'Download', completed: false, required: true }
  ],
  resumeData: {
    personalInfo: {
      name: '',
...
export const ResumeBuilderProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const actions: ResumeBuilderActions = {
    ...
    toggleSection: () => {}, // TODO: Implement
    reorderSections: () => {}, // TODO: Implement
